...
par(mfrow = c(2,2))
par(mar=c(4,4,2,2))
with(el_pow_cn,plot(Full_date,Global_active_power,type="l",xlab="'",ylab="Global Active Power"))
with(el_pow_cn,plot(Full_date,Voltage,type="l",xlab="datetime'",ylab="Voltage"))
...
with(el_pow_cn,plot(Full_date,Global_reactive_power,type="l",xlab="datetime",ylab="Global_Reactive_Power"))
